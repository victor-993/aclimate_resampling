...
Original file is located at
    https://colab.research.google.com/drive/1wK5r7slTfHRv7CDUNQgHa7EfXQn4PMej

Test codigo MV para datos de Colombia
"""
...
def resampling_master(station, input_root, climate_data_root, output_root, year_forecast, forecast_period = 3):
    ...
    prob_normalized = preprocessing(input_root, output_root, forecast_period)
    ...
    save_forecast(output_root = output_root,
                  year_forecast = year_forecast,
                  forecast_period = forecast_period, #tri, bi
                  prob = prob_normalized,
                  base_years = resampling_forecast[0],
                  seasons_range = resampling_forecast[1],
                  station = station)

estaciones = os.listdir("/content/drive/MyDrive/colombia/input/dailyData")
...
for i in range(0, len(n)-1):
  ...
  resampling_master(station = n[i] ,
                   input_root =  "/content/drive/MyDrive/colombia/input/probabilities.csv",
                   climate_data_root = "/content/drive/MyDrive/colombia/input/dailyData",
                   output_root = "/content/drive/MyDrive/colombia/save",
                   year_forecast = 2023 ,
                   forecast_period = "tri")